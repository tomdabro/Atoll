...
enum GoogleCalendarTokenAccount: String {
    ...
    /// the tokens rather than in Defaults since it's still credential material.
...
/// client ID and token expiration are not secrets and stay in Defaults.
struct KeychainGoogleCalendarTokenStore: GoogleCalendarTokenStoring {
    private static let service = "com.Ebullioscopic.Atoll.GoogleCalendar"
